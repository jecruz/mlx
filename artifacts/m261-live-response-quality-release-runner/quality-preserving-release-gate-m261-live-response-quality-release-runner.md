# m261-live-response-quality-release-runner Quality-Preserving Release Gate
...
- `response_quality_regression_candidate` (response_quality): `PASS` - `artifacts/m261-live-response-quality-release-runner/candidate-vs-baseline-m261-live-response-quality-release-runner.json`
